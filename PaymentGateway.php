...
abstract class PaymentGateway
{
    ...
    public function submitPayment()
    {
		...
		?>
		<div id="paybuttondiv">
		<button type="button" class="btn btn-primary" value="" id="back3" name="back3" onclick="loadthirdmodal()">&larr; <?php _e('Back', 'appointzilla'); ?></button>
		<button type="submit" class="btn btn-primary"><?php _e('Pay With Paypal', 'appointzilla'); ?></button>
		</div>
		<?php
		 echo "</form>";
